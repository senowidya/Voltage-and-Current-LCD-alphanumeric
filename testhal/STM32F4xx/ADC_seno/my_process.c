...
float current1voltdiver;
float current2voltdiver;
int   i;
...
//     current1voltdiver= (float) ((adc_val19-20)*adctovoltage_real);
//     current1=(float) (current1voltdiver*37.5)-63.7;
//     current2voltdiver= (float) ((adc_val20-15)*adctovoltage_real);
//     current2=(float) (current2voltdiver*37.5)-63.6;
//     }
